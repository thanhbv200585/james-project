...
class FutureReleaseEHLOHookTest {
    ...
    void ehloShouldAdvertiseFutureReleaseExtension() throws Exception {
        InputStream inputStream = ClassLoader.getSystemResourceAsStream("smtpserver-futurerelease.xml");
        smtpServer.configure(FileConfigurationProvider.getConfig(inputStream));
        smtpServer.init();
